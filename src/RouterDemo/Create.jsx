...
class Create extends Component{
    ...
    checkAndUpdate = () => {
        ...
        if(validateToken){
            let data = {}
            this.graphicCardColumn.map((item) => {
    ...
    render(){
        ...
        return(
            // <FillinForm data={this.state.data} column={this.graphicCardColumn}
            // color={this.state.color} changeHandle={this.checkValidation}
            // warning={this.state.warning} submitting={this.state.submitting}
            // clickHandle={this.checkAndUpdate}/>
            <form>
                {this.graphicCardColumn.map(item =>
